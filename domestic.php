...
<head>
    ...
    <meta content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=5, user-scalable=1"
        name=viewport>
    <meta name=csrf-token content="8exspSC5r9kbJvZpgnRNHpwD2nIIpCPIQuS2aXkl">
    <style>
        :root {
    ...
    <script
        type=application/ld+json>{"@context":"https:\/\/schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https:\/\/jobbox.archielite.com"},{"@type":"ListItem","position":2,"name":"Jobs","item":"https:\/\/jobbox.archielite.com\/jobs"}]}</script>
    <script
    ...
    <style>
        .page_speed_1028198837 {
            display: none;
        }

        .page_speed_1504440977 {
            height: 16px;
            width: auto;
        }

        .page_speed_1660542144 {
            background-color: #f8d7da;
            border: 0;
            background-image: unset
        }

        .page_speed_1254188467 {
            background-image: url(https://jobbox.archielite.com/storage/general/newsletter-background-image.png)
        }

        .page_speed_1070646486 {
            display: none
        }

        .page_speed_1876131491 {
            max-width: 1170px;
        }

        .page_speed_1714842563 {
...
<body id="page-7">
    ...
    <main class="main">
                        ...
                        <div class="banner-inner">
                            <div class="block-banner">
                                <h1 class="text-42 color-white wow animate__animated animate__fadeInUp"> The official
                                    <span class="color-green">IT Jobs</span> site
                                </h1>
                                ...
                                <div class="swiper-container swiper-group-3 swiper">
                                    <div class="swiper-wrapper pb-25 pt-5">
                                        <div class="swiper-slide hover-up"><a
                                                ...
                                                <div class="item-logo">
                                                    <div class="image-left"><img
                                                            src=https://jobbox.archielite.com/storage/general/management.png
                                                            alt="Management"></div>
                                        ...
                                        <div class="swiper-slide hover-up"><a
                                                ...
                                                <div class="item-logo">
                                                    <div class="image-left"><img
                                                            src=https://jobbox.archielite.com/storage/general/retail.png
                                        ...
                                        <div class="swiper-slide hover-up"><a
                                                ...
                                                <div class="item-logo">
                                                    <div class="image-left"><img
                                                            src=https://jobbox.archielite.com/storage/general/security.png
                                                            alt="Security Analyst"></div>
                                                    <div class="text-info-right">
                                                        <h4>Security Analyst</h4>
                                                        <p class="font-xs"> 2 <span>Jobs Available</span></p>
                                                    </div>
                                                </div>
                                            </a></div>
                                    </div>
                                                    ...
                                                    <div class="row position-relative mt-10 mb-20">
                                                        <div class="col-sm-12 box-slider-range">
                                                            <div id="slider-range" data-current-range="0"
                                                                data-max-salary-range="18800"></div>
                                                        ...
                                                        <div class="box-input-money"><input
                                                                ...
                                                                class="input-disabled form-control submit-form-filter"
                                                                name=offered_salary_to type=hidden value="18800"
                                                                data-default-value="18800"></div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="filter-block mb-30">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-lg-7 text-lg-end mt-sm-15">
                                                <div class="display-flex2">
                                                    <div class="box-border btn-advanced-filter"><svg
                                                    ...
                                                    <div class="box-border mr-10"><span
                                                        ...
                                                        <div class="dropdown dropdown-sort"><button
                                                            ...
                                                            <ul class="dropdown-menu js-dropdown-clickable dropdown-menu-light"
                                                                ...
                                                                <li><a class="dropdown-item per-page-item" href="#"
                                                                        data-per-page="12">12</a><a
                                                                        class="dropdown-item per-page-item" href="#"
                                                                        data-per-page="24">24</a><a
                                                                        class="dropdown-item per-page-item" href="#"
                                                                        data-per-page="36">36</a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
        ...
        <section class="section-box mt-50 mb-20">
            <div class="container">
                <div class="box-newsletter page_speed_1254188467">
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-xl-6 col-12">
                            ...
                            <div class="box-form-newsletter mt-40">
                                <form method="POST" action="https://jobbox.archielite.com/newsletter/subscribe"
                                    ...
                                    <input name=_token type=hidden value="8exspSC5r9kbJvZpgnRNHpwD2nIIpCPIQuS2aXkl">
                                    ...
                                    <div class="newsletter-message newsletter-success-message page_speed_1070646486">
                                    </div>
                                    <div class="newsletter-message newsletter-error-message page_speed_1070646486">
                                    </div>
                                </form>
                            </div>
                        </div>
        ...
        <div class="site-notice-body page_speed_footer">
            ...
            <div class="site-notice__categories">
                ...
                <div class="site-notice__save"><button
                        class="js-site-notice-save site-notice__save-button page_speed_1714842563"> Save preferences
                    </button></div>
            </div>
        </div>
    </div>
    ...
    <script defer
        ...
        data-cf-beacon='{"version":"2024.11.0","token":"e8235d3b3ca94119b090edda40247050","r":1,"server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}'
