            ...
            <div>
                <section class="section-box">
                    <div class="banner-hero hero-2 hero-3">
                        <div class="banner-inner">
                            <div class="block-banner">
                                <h1 class="text-42 color-white wow animate__animated animate__fadeInUp"> The official
                                    <span class="text-primary">IT Jobs</span> site
                                </h1>
                                ...
                                <div class="form-find position-relative mt-40 wow animate__animated animate__fadeIn"
                                    ...
                                    <form method="GET" action="" accept-charset="UTF-8"
                                        ...
                                        <div class="search-btn-group"><button
                                                class="btn btn-default font-sm btn-gradient">Search</button><button
                        ...
                        <div class="container mt-60 w-75 px-lg-5">
                                        ...
                                        <div class="swiper-slide hover-up"><a
                                                ...
                                                <div class="item-logo">
                                                    <div class="image-left"><img
                                                            ...
                                                            alt="Food & Beverage "></div>
                                                    <div class="text-info-right">
                                                        <h4>Food & Beverage </h4>
                                                        <p class="font-xs"> 29 <span>Jobs Available</span></p>
                                                    </div>
                                                </div>
                                            </a></div>
                                        <div class="swiper-slide hover-up"><a
            ...
            <div class="container">
                <div class="box-newsletter newsletter-bg">
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-12 text-center d-none d-xl-block"><img
                                src="storage/general/newsletter-image-right.png" alt="Recany"></div>
                    </div>
                </div>
            </div>
        </section>
