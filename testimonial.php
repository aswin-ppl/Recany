...
<head>
    ...
    <script
        type=application/ld+json>{"@context":"https:\/\/schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https:\/\/jobbox.archielite.com"},{"@type":"ListItem","position":2,"name":"About us","item":"https:\/\/jobbox.archielite.com\/about-us"}]}</script>
    <script
    ...
    <style>
        ...
        .test-video-1 {
            background-image: url('./imgs/page/testimonial/img1.png');
            background-position: center;
        }

        .test-video-2 {
            background-image: url('./imgs/page/testimonial/img2.jpg');
            background-position: center;
        }

        .test-video-3 {
            background-image: url('./imgs/page/testimonial/img3.png');
            background-position: center;
        }
    </style>
</head>
        ...
        <div class="ck-content">
            ...
            <div class="py-5">
                <section class="section-box mt-50">
                    <div class="section-box wow animate__ animate__fadeIn animated"
                        style="visibility: visible; animation-name: fadeIn;">
                        <div class="container">
                            <div class="text-start">
                                <h2 class="section-title mb-10 wow animate__ animate__fadeInUp secondary-text-color"
                                    style="visibility: visible; animation-name: fadeInUp;"><span
                                        class="text-primary">Testimonial</span> Videos</h2>
                                <p class="font-lg color-text-paragraph-2 wow animate__ animate__fadeInUp"
                                    style="visibility: visible; animation-name: fadeInUp;">Search and connect with the
                                    right candidates faster.</p>
                            </div>
                            <div class="box-swiper mt-50">
                                <div
                                    class="swiper-container swiper-group-6 mh-none swiper swiper-initialized swiper-horizontal swiper-pointer-events">
                                    <div class="swiper-wrapper pb-70 pt-5"
                                        style="transition-duration: 0ms; transform: translate3d(-3164px, 0px, 0px);"
                                        id="swiper-wrapper-eb45ad07f7fd5310f" aria-live="off">
                                        <div class="swiper-slide hover-up swiper-slide-duplicate"
                                        ...
                                        <div class="swiper-slide hover-up swiper-slide-duplicate swiper-slide-duplicate-prev"
                                        ...
                                        <div class="swiper-slide hover-up swiper-slide-duplicate-active"
                                        ...
                                        <div class="swiper-slide hover-up swiper-slide-duplicate-next"
                                        ...
                                        <div class="swiper-slide hover-up swiper-slide-duplicate swiper-slide-active"
                                            data-swiper-slide-index="0" style="width: 196px; margin-right: 30px;"
                                            role="group" aria-label="1 / 8">
                                            <div class="card-grid-5 card-category hover-up test-video-3"><a
                                                    href="https://jobbox.archielite.com/job-categories/management">
                                        ...
                                        <div class="swiper-slide hover-up swiper-slide-duplicate swiper-slide-next"
                                            data-swiper-slide-index="1" style="width: 196px; margin-right: 30px;"
                                            role="group" aria-label="2 / 8">
                                            <div class="card-grid-5 card-category hover-up test-video-1"><a
                                                    href="https://jobbox.archielite.com/job-categories/human-resource">
                                ...
                                <div class="swiper-button-next swiper-button-next-1" tabindex="0" role="button"
                                    aria-label="Next slide" aria-controls="swiper-wrapper-a107a06cd57a4906c"></div>
                                <div class="swiper-button-prev swiper-button-prev-1" tabindex="0" role="button"
                                    aria-label="Previous slide" aria-controls="swiper-wrapper-a107a06cd57a4906c"></div>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="section-box wow animate__ animate__fadeIn animated"
                        ...
                        <div class="container">
                            <div class="text-center">
                                <h2 class="section-title mb-10 wow animate__ animate__fadeInUp secondary-text-color"
                                    style="visibility: visible; animation-name: fadeInUp;"> <span class="text-primary">See</span> Some Words </h2>
                                <p class="font-lg color-text-paragraph-2 wow animate__ animate__fadeInUp"
                                    style="visibility: visible; animation-name: fadeInUp;"> Thousands of employee get
                                    their ideal jobs and feed back to us! </p>
                            </div>
                            <div class="box-swiper mt-50">
                                <div class="swiper-container swiper-group-4-border swiper swiper-initialized swiper-horizontal swiper-pointer-events"
                                    id="testimonial-slider-2">
                                    <div class="swiper-wrapper pb-70 pt-5"
                                        style="transform: translate3d(-2019px, 0px, 0px); transition-duration: 0ms;"
                                        id="swiper-wrapper-15e3873848e4b68f" aria-live="off">
                                        <div class="swiper-slide hover-up swiper-slide-duplicate"
                                            data-swiper-slide-index="0" style="width: 316.5px; margin-right: 20px;"
                                            ...
                                            <div class="card-review-1">
                                                ...
                                                <div class="review-info">
                                                    <div class="review-name secondary-text-color">
                                                        <h5 class="secondary-text-color">Ellis Kim</h5><span class="font-xs">Digital Artist</span>
                                                    </div>
                                                    <div class="review-comment secondary-text-color">Hatter, with an anxious look at the
                                                        window, and some 'unimportant.' Alice could think of anything
                                                        else. CHAPTER V. Advice from a bottle marked 'poison,' so Alice
                                                        ventured to ask. 'Suppose we change.</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide hover-up swiper-slide-duplicate swiper-slide-duplicate-prev"
                                            data-swiper-slide-index="1" style="width: 316.5px; margin-right: 20px;"
                                            ...
                                            <div class="card-review-1">
                                                ...
                                                <div class="review-info">
                                                    <div class="review-name secondary-text-color">
                                                        <h5 class="secondary-text-color">John Smith</h5><span class="font-xs">Product designer</span>
                                                    </div>
                                                    <div class="review-comment secondary-text-color">French lesson-book. The Mouse did not
                                                        like the tone of delight, which changed into alarm in another
                                                        minute there was a table, with a sudden burst of tears, but said
                                                        nothing. 'When we were little,'.</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide hover-up swiper-slide-duplicate swiper-slide-duplicate-active"
                                            data-swiper-slide-index="2" style="width: 316.5px; margin-right: 20px;"
                                            ...
                                            <div class="card-review-1">
                                                ...
                                                <div class="review-info">
                                                    <div class="review-name secondary-text-color">
                                                        <h5 class="secondary-text-color">Sayen Ahmod</h5><span class="font-xs">Developer</span>
                                                    </div>
                                                    <div class="review-comment secondary-text-color">Dormouse; 'VERY ill.' Alice tried to say
                                                        but 'It belongs to the puppy; whereupon the puppy began a series
                                                        of short charges at the top of her head to keep back the
                                                        wandering hair that curled all over.</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide hover-up swiper-slide-duplicate swiper-slide-duplicate-next"
                                            data-swiper-slide-index="3" style="width: 316.5px; margin-right: 20px;"
                                            ...
                                            <div class="card-review-1">
                                                ...
                                                <div class="review-info">
                                                    <div class="review-name secondary-text-color">
                                                        <h5 class="secondary-text-color">Tayla Swef</h5><span class="font-xs">Graphic designer</span>
                                                    </div>
                                                    <div class="review-comment secondary-text-color">She soon got it out to sea as you might
                                                        like to hear it say, as it is.' 'I quite agree with you,' said
                                                        the Mock Turtle's Story 'You can't think how glad I am now?
                                                        That'll be a comfort, one.</div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="swiper-slide hover-up" data-swiper-slide-index="0"
                                        ...
                                        <div class="swiper-slide hover-up swiper-slide-prev" data-swiper-slide-index="1"
                                        ...
                                        <div class="swiper-slide hover-up swiper-slide-active"
                                            data-swiper-slide-index="2" style="width: 316.5px; margin-right: 20px;"
                                            role="group" aria-label="3 / 4">
                                            <div class="card-review-1">
                                                <div class="image-review"><img
                                        ...
                                        <div class="swiper-slide hover-up swiper-slide-next" data-swiper-slide-index="3"
                                    ...
                                    <div
                                        class="swiper-pagination swiper-pagination-style-border swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal">
                                        <span class="swiper-pagination-bullet" tabindex="0" role="button"
                                            ...
                                            tabindex="0" role="button" aria-label="Go to slide 4"></span></div><span
