        ...
        <div class="ck-content">
            ...
            <div class="pb-5">
                <section class="section-box mt-50 mb-30 pt-20 pb-20">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6"><img class="bdrd-10" src="./imgs/page/about/team.png" alt="jobBox">
                            </div>
                            <div class="col-lg-6 align-self-center">
                                <div class="pl-30">
                                    <h3 class="secondary-text-color mt-0 mb-15"><span
                                            class="text-primary">Recany</span>, Thrive to Hire</h3>
                                    <p class="font-sm color-text-paragraph-2">Recany has been immensely successful in
                                        creating a global network of highly adept intelligent workforce that can help a
                                        company achieve their mission-critical projects and goals.</p>
                                    </br>
                                    <p>
                                        Keeping pace with projects and being on the lookout for the extremely talented
                                        individuals has become ever more challenging. Here is where Recany comes into
                                    ...
                                    <p>
                                        ...
                                        performance. We appreciate the experience that our candidates bring from various
                                        industries and we like to leverage it for the mutual benefit of both clients and
                                        candidates. We specialize in Mechanical, Electrical, BPO, IT, Electronics, FMCG,
                                        Automobile, Healthcare, Commercial, Retail, and Startup hiring.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section class="section-box mt-70 job-of-the-day">
                    <div class="container">
                        <div class="text-center">
                            ...
                            <h2
                                class="secondary-text-color mb-10 wow animate__ animate__fadeInUp animated page_speed_1928531640">
                        ...
                        <div class="mt-50">
                            <div>
                                <div id="tab-job-1" data-="" aria-labelledby="tab-job-1"
                                    class="tab-pane fade show active page_speed_1843088790">
                                    <div class="row job-of-the-day-list justify-content-center">
                                        <div class="loading-ring" style="display: none;">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                                            <div class="card-grid-2 grid-bd-16 hover-up item-grid ">
                                                <div class="card-grid-2-image p-4">
                                                    <div class="image-box">
                                                        <figure><img src="./storage/jobs/img6.png"
                                                                alt="DevOps Account Executive - US Public Sector">
                                                        </figure>
                                                    </div>
                                                </div>
                                                <div class="card-block-info">
                                                    <div class="h6 font-bold text-center"><a
                                                            href="https://jobbox.archielite.com/jobs/devops-account-executive-us-public-sector"
                                                            class="name-job secondary-text-color"
                                                            title="Our Vision"><span class="text-primary">Our</span>
                                                            Vision</a></div>
                                                    <p
                                                        class="font-sm color-text-paragraph job-description text-center mt-20">
                                        ...
                                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-12 col-12">
                                            <div class="card-grid-2 grid-bd-16 hover-up item-grid ">
                                                <div class="card-grid-2-image p-4">
                                                    <div class="image-box">
                                                        <figure><img src="./storage/jobs/img5.png"
                                                                alt="DevOps Account Executive - US Public Sector">
                                                        </figure>
                                                    </div>
                                                </div>
                                                <div class="card-block-info">
                                                    <div class="h6 font-bold text-center"><a
                                                            href="https://jobbox.archielite.com/jobs/devops-account-executive-us-public-sector"
                                                            class="name-job secondary-text-color"
                                                            title="Our Mission"><span class="text-primary">Our</span>
                                                            Mission</a></div>
                                                    <p
                                                        class="font-sm color-text-paragraph job-description mt-20 text-center">
                                                        “Friendly, expert and trusted specialists delivering the right
            ...
            <div class="pb-5">
                <section class="section-box mt-50 mb-30 pt-20 pb-20">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-6"><img class="bdrd-10" src="./imgs/page/about/why-us.png" alt="jobBox">
                            </div>
                            <div class="col-lg-6 align-self-center">
                                <div class="pl-30">
                                    <h3 class="secondary-text-color mt-0 mb-15"><span
                                            class="text-primary">Why</span> Recany</h3>
                                    <p class="font-sm color-text-paragraph-2">
                                        <i class="fa-regular fa-square-check text-success"></i>&emsp;Recany has a highly skilled set of talents that are built on referral and successful partnerships.</p>
                                    </br>
                                    <p>
                                        <i class="fa-regular fa-square-check text-success"></i>&emsp;Our recruiters are exceptionally skilled in identifying top talent around the globe and matching them with the client's needs.
                                    </p>
                                    </br>
                                    <p>
                                        <i class="fa-regular fa-square-check text-success"></i>&emsp;90% of the candidates we placed continued to work over 2 years.</p>
                                    </br>
                                    <p>
                                        <i class="fa-regular fa-square-check text-success"></i>&emsp;Clear & transparent process, we go the extra mile to fulfill your hiring needs.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                <div class="text-center">
                                    <h3 class="color-brand-2"><span class="count">18</span></h3>
                                    <p class="font-sm color-text-paragraph mt-10">Years Combined
Recruitment Experience</p>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                <div class="text-center">
                                    <h3 class="color-brand-2"><span class="count">54</span><span>+</span></h3>
                                    <p class="font-sm color-text-paragraph mt-10">Clients & Growing</p>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                <div class="text-center">
                                    <h3 class="color-brand-2"><span class="count">306</span><span>+</span></h3>
                                    <p class="font-sm color-text-paragraph mt-10">Candidates Placed
Successfully</p>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 col-12">
                                <div class="text-center">
                                    <h3 class="color-brand-2"><span class="count">4500</span><span>+</span></h3>
                                    <p class="font-sm color-text-paragraph mt-10">Candidates in our
Database</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="box-newsletter newsletter-bg">
                        <div class="row">
                            <div class="col-xl-3 col-12 text-center d-none d-xl-block"><img
                                    src="storage/general/newsletter-image-left.png"
                                    alt="JobBox - Laravel Job Board Script">
                            </div>
                            <div class="col-lg-12 col-xl-6 col-12">
                                ...
                                <div class="box-form-newsletter mt-40">
                                    <form method="POST" action="https://jobbox.archielite.com/newsletter/subscribe"
                                        ...
                                        <div
                                            class="newsletter-message newsletter-success-message page_speed_1782753614">
                                        </div>
