...
<head>
    ...
    <meta name=description content="Memories captured, moments forever cherished">
    ...
    <meta property="og:description" content="Memories captured, moments forever cherished">
    ...
    <meta name=twitter:title content="Our Photos">
    <meta name=twitter:description content="Memories captured, moments forever cherished">
    ...
    <script
        type=application/ld+json>{"@context":"https:\/\/schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https:\/\/jobbox.archielite.com"},{"@type":"ListItem","position":2,"name":"Our Photos","item":"https:\/\/jobbox.archielite.com\/about-us"}]}</script>
    <script
        ...
        <section class="section-box">
            <div class="breadcrumb-cover bg-img-about page_speed_151892195">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <h2 class="mb-10">Our Photos</h2>
                            <p class="font-lg color-text-paragraph-2">Memories captured, moments forever cherished</p>
                        </div>
                    ...
                    <div class="container">
                        <div class="text-center py-4">
                            ...
                            <h2
                                ...
                                <span class="text-primary">Our</span> Photos
                            </h2>
                            <p
                        ...
                        <div class="d-flex flex-wrap flex-lg-nowrap mt-50">
                            <div class="block-banner-1">
                                <div class="block-image block-image-1"><img src="./imgs/page/photos/img1.png"
                                        alt="photos/img1.png"></div>
                                <div class="block-image block-image-2"><img src="./imgs/page/photos/img2.png"
                                        alt="photos/img2.png"></div>
                            </div>
                            <div class="block-banner-1">
                                <div class="block-image block-image-3"><img src="./imgs/page/photos/img3.jpg"
                                        alt="photos/img3.jpg"></div>
                                <div class="block-image block-image-3"><img src="./imgs/page/photos/img4.png"
                                        alt="photos/img4.png"></div>
                            </div>
                            <div class="block-banner-1">
                                <div class="block-image block-image-4"><img src="./imgs/page/photos/img5.png"
                                        alt="photos/img5.png"></div>
                            </div>
                        </div>
                    </div>
                </section>
