        ...
        <section class="section-box">
            <div class="breadcrumb-cover bg-img-about page_speed_151892195">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <h2 class="mb-10">Success Story</h2>
                            <p class="font-lg color-text-paragraph-2">Stories of succesed ones</p>
                        </div>
            ...
            <div class="py-5">
                <div class="container mt-50">
                    <div class="text-center">
                        ...
                        <h2 class="section-title mb-10 wow animate__ animate__fadeInUp  page_speed_1461932338 animated secondary-text-color"
                            style="visibility: visible; animation-name: fadeInUp;"><span
                                class="text-primary">Success</span> Story </h2>
                        <p class="font-sm color-text-paragraph w-lg-50 mx-auto wow animate__ animate__fadeInUp  page_speed_1461932338 animated"
                            style="visibility: visible; animation-name: fadeInUp;"> Lorem ipsum dolor sit amet,
                            consectetur adipiscing elit. Quisque ligula ante, dictum non aliquet eu, dapibus ac quam.
                        </p>
                    </div>
                    <div class="row mt-70">
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-md-30">
                            <div class="card-grid-4 text-center hover-up">
                                <div class="image-top-feature">
                                    <figure><img alt="Jack Persion"
                                            src="./storage/teams/1.png"></figure>
                                </div>
                                <div class="card-grid-4-info">
                                    <h5 class="mt-10 text-dark">Jack Persion</h5>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-md-30">
                            <div class="card-grid-4 text-center hover-up">
                                <div class="image-top-feature">
                                    <figure><img alt="Tyler Men"
                                            src="./storage/teams/2.png"></figure>
                                </div>
                                <div class="card-grid-4-info">
                                    <h5 class="mt-10 text-dark">Tyler Men</h5>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-md-30">
                            <div class="card-grid-4 text-center hover-up">
                                <div class="image-top-feature">
                                    <figure><img alt="Mohamed Salah"
                                            src="./storage/teams/3.png"></figure>
                                </div>
                                <div class="card-grid-4-info">
                                    <h5 class="mt-10 text-dark">Mohamed Salah</h5>
                                    <p class="font-xs color-text-paragraph-2 mt-5 mb-5">Developer Fullstack</p><span
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-md-30">
                            <div class="card-grid-4 text-center hover-up">
                                <div class="image-top-feature">
                                    <figure><img alt="Xao Shin" src="./storage/teams/4.png">
                                    </figure>
                                </div>
                                <div class="card-grid-4-info">
                                    <h5 class="mt-10 text-dark">Xao Shin</h5>
                                    <p class="font-xs color-text-paragraph-2 mt-5 mb-5">Developer Fullstack</p><span
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-md-30">
                            <div class="card-grid-4 text-center hover-up">
                                <div class="image-top-feature">
                                    <figure><img alt="Peter Cop"
                                            src="./storage/teams/5.png"></figure>
                                </div>
                                <div class="card-grid-4-info">
                                    <h5 class="mt-10 text-dark">Peter Cop</h5>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-md-30">
                            <div class="card-grid-4 text-center hover-up">
                                <div class="image-top-feature">
                                    <figure><img alt="Jacob Jones"
                                            src="./storage/teams/6.png"></figure>
                                </div>
                                <div class="card-grid-4-info">
                                    <h5 class="mt-10 text-dark">Jacob Jones</h5>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-md-30">
                            <div class="card-grid-4 text-center hover-up">
                                <div class="image-top-feature">
                                    <figure><img alt="Court Henry"
                                            src="./storage/teams/7.png"></figure>
                                </div>
                                <div class="card-grid-4-info">
                                    <h5 class="mt-10 text-dark">Court Henry</h5>
                        ...
                        <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12 mb-md-30">
                            <div class="card-grid-4 text-center hover-up">
                                <div class="image-top-feature">
                                    <figure><img alt="Theresa" src="./storage/teams/8.png">
                                    </figure>
                                </div>
                                <div class="card-grid-4-info">
                                    <h5 class="mt-10 text-dark">Theresa</h5>
                                    <p class="font-xs color-text-paragraph-2 mt-5 mb-5">Backend Developer</p><span
