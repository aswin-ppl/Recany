...
<head>
    ...
    <meta name=description content="Highlighting Opportunities for Career Growth">
    <link rel="canonical" href="en/about-us.html">
    <meta name=robots content="index, follow">
    <meta property="og:site_name" content="JobBox - Laravel Job Board Script">
    <meta property="og:type" content="article">
    <meta property="og:title" content="Job Banner">
    <meta property="og:description" content="Highlighting Opportunities for Career Growth">
    <meta property="og:url" content="">
    <meta property="og:image" content="">
    <meta name=twitter:title content="Job Banner">
    <meta name=twitter:description content="Highlighting Opportunities for Career Growth">
    ...
    <script
        type=application/ld+json>{"@context":"https:\/\/schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https:\/\/jobbox.archielite.com"},{"@type":"ListItem","position":2,"name":"Job Banner","item":"https:\/\/jobbox.archielite.com\/about-us"}]}</script>
    <script
        ...
        <section class="section-box">
            <div class="breadcrumb-cover bg-img-about page_speed_151892195">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <h2 class="mb-10">Job Banner</h2>
                            <p class="font-lg color-text-paragraph-2">Highlighting Opportunities for Career Growth</p>
                        </div>
                    ...
                    <div class="container">
                        <div class="text-center py-4">
                            ...
                            <h2
                                ...
                                <span class="text-primary">Job</span> Banner
                            </h2>
                            <p
                        ...
                        <div class="d-flex justify-content-center flex-wrap flex-lg-nowrap mt-50">
                            <div class="block-banner-1">
                                <div class="block-image block-image-1"><img
                                        src="./imgs/page/job-banner/img1.png"
                                        alt="galleries/1.jpg"></div>
                                <div class="block-image block-image-2"><img
                                        src="./imgs/page/job-banner/img2.png"
                                        alt="galleries/1.jpg"></div>
                            </div>
                            <div class="block-banner-1">
                                <div class="block-image block-image-3"><img
                                        src="./imgs/page/job-banner/img3.png"
                                        alt="galleries/1.jpg"></div>
                                <div class="block-image block-image-3"><img
                                        src="./imgs/page/job-banner/img4.png"
                                        alt="galleries/1.jpg"></div>
                            </div>
                            <div class="block-banner-1">
                                <div class="block-image block-image-4"><img
                                        src="./imgs/page/job-banner/img5.png"
                                        alt="galleries/1.jpg"></div>
                                <div class="block-image block-image-5"><img
                                        src="./imgs/page/job-banner/img6.png"
                                        alt="galleries/1.jpg"></div>
                            </div>
                            <div class="block-banner-1">
                                <div class="block-image block-image-4"><img
                                        src="./imgs/page/job-banner/img7.png"
                                        alt="galleries/1.jpg"></div>
                                <div class="block-image block-image-5"><img
                                        src="./imgs/page/job-banner/img8.png"
                                        alt="galleries/1.jpg"></div>
                            </div>
                        </div>
                    </div>
