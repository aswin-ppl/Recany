...
<head>
    ...
    <title>Achievements & Awards</title>
    <meta name=description content="Recognition for excellence and success.">
    ...
    <script
        type=application/ld+json>{"@context":"https:\/\/schema.org","@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https:\/\/jobbox.archielite.com"},{"@type":"ListItem","position":2,"name":"Achievements & Awards","item":"https:\/\/jobbox.archielite.com\/about-us"}]}</script>
    <script
        type=application/ld+json>{"@context":"https:\/\/schema.org","@type":"WebSite","name":"","url":"https:\/\/jobbox.archielite.com"}</script>
    <script
        type=application/ld+json>{"@context":"https:\/\/schema.org","@type":"Organization","name":"","url":"https:\/\/jobbox.archielite.com\/about-us","logo":{"@type":"ImageObject","url":"https:\/\/jobbox.archielite.com\/storage\/general\/logo.png"}}</script>
        ...
        <section class="section-box">
            <div class="breadcrumb-cover bg-img-about page_speed_151892195">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <h2 class="mb-10">Achievements & Awards</h2>
                            <p class="font-lg color-text-paragraph-2">Recognition for excellence and success.</p>
                        </div>
                    ...
                    <div class="container">
                        <div class="text-center py-4">
                            ...
                            <h2
                                ...
                                <span class="text-primary">Achievements</span>  & Awards
                            </h2>
                            <p
                        ...
                        <div class="d-flex flex-wrap flex-lg-nowrap mt-50 justify-content-center">
                            <div class="block-banner-1">
                                <div class="block-image block-image-1"><img src="./imgs/page/achievements-and-awards/img1.png"
                                        alt="achievements-and-awards/img1.png"></div>
                                <div class="block-image block-image-2"><img src="./imgs/page/achievements-and-awards/img2.png"
                                        alt="achievements-and-awards/img2.png"></div>
                                <div class="block-image block-image-2"><img src="./imgs/page/achievements-and-awards/img3.png"
                                        alt="achievements-and-awards/img3.png"></div>
                            </div>
                            <div class="block-banner-1">
                                <div class="block-image block-image-3"><img src="./imgs/page/achievements-and-awards/img4.png"
                                        alt="achievements-and-awards/img4.png"></div>
                                <div class="block-image block-image-3"><img src="./imgs/page/achievements-and-awards/img5.png"
                                        alt="achievements-and-awards/img5.png"></div>
                                <div class="block-image block-image-3"><img src="./imgs/page/achievements-and-awards/img6.png"
                                        alt="achievements-and-awards/img6.png"></div>
                            </div>
                            <div class="block-banner-1">
                                <div class="block-image block-image-4"><img src="./imgs/page/achievements-and-awards/img7.png"
                                        alt="achievements-and-awards/img7.png"></div>
                                <div class="block-image block-image-4"><img src="./imgs/page/achievements-and-awards/img8.png"
                                        alt="achievements-and-awards/img8.png"></div>
                            </div>
                        </div>
                    </div>
                </section>
